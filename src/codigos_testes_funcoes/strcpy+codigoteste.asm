...
.text
	main:
	la $a0, destino	#a0 � o inicio do array do destination (destino)
	la $a1, origem	#a1 � o inicio do array de source (origem)
	...
	strcopy: #Para utilizar essa fun��o obrigat�riamente deve ser passado como par�metro nos registradores a0 e a1 o ENDERE�O, por meio da fun��o "la" (LOAD ADDRESS)
